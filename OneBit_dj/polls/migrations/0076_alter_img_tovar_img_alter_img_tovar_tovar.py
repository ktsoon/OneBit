# Generated by Django 5.0.3 on 2025-02-19 13:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('polls', '0075_alter_comments_tovar_alter_img_tovar_img_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='img_tovar',
            name='tovar',
            field=models.ForeignKey(help_text='Выберите товар', on_delete=django.db.models.deletion.CASCADE, related_name='images', to='polls.tovars'),
        ),
    ]
